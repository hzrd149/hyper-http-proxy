/**
 * Copied from https://github.com/TooTallNate/proxy-agents/blob/b5f94e3222c0aaa3bc56218ff125e2c56417c86e/packages/proxy/src/proxy.ts
 * Modified to use HyperAgent for hypr1 addresses
 */
...
export function createProxy(
  ...
  let proxy = (server as ProxyServer) || (http.createServer() as ProxyServer);
...
async function onrequest(
  ...
  let hasVia = false;
  const via = "1.1 " + hostname + " (proxy/" + 1 + ")";
